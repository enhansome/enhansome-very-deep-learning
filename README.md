...
1. Authors [Autograd Implementation](https://github.com/HIPS/autograd/blob/master/examples/ode_net.py) ⭐ 7,534 | 🐛 188 | 🌐 Python | 📅 2026-09-21
...
* [Densely Connected Convolutional Networks (2016)](https://arxiv.org/abs/1608.06993) \[[original code](https://github.com/liuzhuang13/DenseNet) ⭐ 4,870 | 🐛 30 | 🌐 Lua | 📅 2024-01-09], introduces DenseNets and shows that it outperforms ResNets in CIFAR10 and 100 by a large margin (especially when not using data augmentation), while only requiring half the parameters. CVPR 2017 best paper.
...
6. Authors' [Caffe Implementation](https://github.com/liuzhuang13/DenseNetCaffe) ⭐ 268 | 🐛 9 | 🌐 Python | 📅 2017-08-11
...
* [Deep Residual Learning for Image Recognition (2015)](http://arxiv.org/abs/1512.03385) \[[original code](https://github.com/KaimingHe/deep-residual-networks) ⭐ 6,758 | 🐛 59 | 📅 2017-10-28], original paper introducing residual neural networks
...
1. Tensorflow with skflow, with MNIST: [code](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/skflow/resnet.py) ⭐ 200,325 | 🐛 3,327 | 🌐 C++ | 📅 2026-09-26
...
12. Wide Residual Networks in Keras: [code](https://github.com/asmith26/wide_resnets_keras) ⭐ 139 | 🐛 6 | 🌐 Python | 📅 2024-01-18
