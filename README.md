...
* [Deep Residual Learning for Image Recognition (2015)](http://arxiv.org/abs/1512.03385) \[[original code](https://github.com/KaimingHe/deep-residual-networks) ⭐ 6,754 | 🐛 59 | 📅 2017-10-28], original paper introducing residual neural networks
...
1. Tensorflow with skflow, with MNIST: [code](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/skflow/resnet.py) ⭐ 200,155 | 🐛 3,146 | 🌐 C++ | 📅 2026-09-17
